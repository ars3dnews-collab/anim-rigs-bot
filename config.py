...
# Шаг между постами, минут. Совпадает с расписанием в rigs.yml.
POST_EVERY_MINUTES = 20

# Допуск: если с прошлого поста прошло хотя бы столько минут, публикуем.
# Нужен потому, что GitHub запускает задание не секунда в секунду, и без
# допуска каждый второй слот пропускался бы из-за опоздания на минуту.
MIN_GAP_MINUTES = 15
